var roomArray = [
	{
		//Index 0
		image:'<img src="Hypnos.jpg" alt="view" style="height:630px;width:1050px;">',
		title:'...',
		text:'The bright sun light blinds you as your eyes adjust to your surroundings, a beautiful green field with vast mountain ranges surrounding it.'+' </br></br>'+' You hear the birds chirping in the distant, a melodic tune you swore you heard a street performer playing a few days ago in the subway. '+' </br></br>'+'The colors of the area seem to radiate and give off their own light. As you you look around you notice you are not alone.\"Mother told me you were coming\" said the cheerful man. He was a tall slender person with bright red hair which looked like he just got out of bed. He wore a blue robe that looked similar to your aunts bathrobe. '+' </br></br>'+'He had a happy but tired smile to him and his eyes seemed to be closed like he was asleep. His entire being seemed like he just woke up and was in dire need of a coffee.\"Hello I am Hypnos, the God of Sleep',
		choices:[
			{
	...
	},
  {
		...
		image:'<img src="Hypnos.jpg" alt="view" style="height:630px;width:1050px;">',
		title:'Hypnos',
		text:'\"It is a pleasure to meet you,it is rare for people to introduce themselves nowadays, they are always so busy and in a rush.\" '+' </br></br>'+'He pouted a little which made you wonder who the god has been talking to recently and whether the encounter went well.',
		choices:[
			{
				text:'\"Where am I ?\"',
				index:2
  ...
  {
		//Index 6
		image:'<img src="crossing.png" alt="view" style="height:630px;width:1050px;">',
		title:'Crossroads',
    ...
    choices:[
			...
			{
				text:'<a href="UnderMaintenance.html">\"Aurora Glade\"',
			},
			{
				text:'<a href="UnderMaintenance.html">\"Chesil Peak\"',
			},
			{
				text:'<a href="UnderMaintenance.html">\"Mallbard Tree\"',
			},
  ...
  {
		//Index 7
		image:'<img src="town.png" alt="view" style="height:630px;width:1050px;">',
		title:'Town Entrance',
  ...
  {
		//Index 8
		image:'<img src="Cole.png" alt="view" style="height:630px;width:1050px;">',
		title:'Tavern',
  ...
  {
		//Index 16
		image:'<img src="Luca.png" alt="view" style="height:630px;width:1050px;">',
		title:'Library',
...
{
	//Index 29
	image:'<img src="Store.jpg" alt="view" style="height:630px;width:1050px;">',
...
{
	//Index 34
	image:'<img src="Arnette.tif" alt="view" style="height:630px;width:1050px;">',
	title:'Guard Tower',
...
},
{
	...
	image:'<img src="Store.jpg" alt="view" style="height:630px;width:1050px;">',
	title:'The Hunt',
	text:'You are staring at the trail and conflicted on what to do. Tick. \"Am I strong enough?\".Tock. \"Is it the Melas\". Tick. \"Should I tell Hypnos?\". Tock. You run into the forest. ',
	choices:
	[
		{
			text:'Continue',
...
{
	//Index 39
	image:'<img src="melasAni2.gif" alt="view" style="height:630px;width:1050px;">',
	title:'Darkness',
	text:'Darkness consumes you comepletly and you cannot see anything. Then from the shadows a figure appears.'+'</br></br>'+' \"Ah you are finally awake.\" said a voice that changed with every single word. One moment it is a soft spoken voice and the next it was as rough as sand paper. '+'</br></br>'+'Each word chilled your bones and froze you in place. '+'</br></br>'+'As the figure appears you notice a great hulking beast standing in front of you, with a skull of a bull rested where a head should be. Its body was long and slender and covered in shaggy hair. It\'s eyes glowed and stared straight in to your soul. '+'</br></br>'+'\" I believe you are looking for me.\"',
	choices:
	[
		{
			text:'<a href="Credits.html">Continue</a>',
		},
	]
},
{
